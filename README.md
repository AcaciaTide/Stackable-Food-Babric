...
- **Configurable:** Fully configurable limits via GlassConfigAPI. You can easily adjust the maximum stack size from the mod menu.
- **Stew Support:** Consuming Mushroom Stew from a stack will correctly return an empty bowl to your inventory (or drop it on the ground if your inventory is full), saving the remaining stews in your hand.
